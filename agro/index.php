        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">AgroTech</h1>
              <p class="text-white">
            ...
            <div class="col-12 col-sm-3 offset-sm-2 align-self-center">
              <img src="assets/img/plant-bulb3.png" class="img-fluid" alt="" width="300%"/>
            </div>
          </div>
        </div>
      </header>
      ...
      <div class="container ">
        ...
        <div class="row">
                <div class="col-md-8 mx-auto text-center">
                    ...
                    <h3 class="display-3 ">Features you will find in the system</h3>
                </div>
            </div>
			<br>
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Farmers can get recommendations for crop and fertilizer and even 
            predict the yield of how much crops you will harvest.</p>
          ...
          <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5  pull-right" src="assets/img/agric.png" width="100%">
          </div>
        </div>
		        ...
		        <div class="row align-items-center">
				  <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5" src="assets/img/crops.png" width="95%">
          </div>
            ...
            <div class="info info-horizontal info-hover-warning mt-5">
              <div class="description pl-4">
                <h3 class="title">Crops</h3>
                  ...
                  <ul class=" ">
                    <li>In crop recommendation area, you should enter all the inputs required in all the fields </li>
                    <p> Crop recommendation gives you the required crop to plant, according to the sample soil and environment state is. </p>
                    <li>In Fertilizer recommendation area, you should enter the all inputs required in all the fields </li>
                    <p> Fertilizer recommendation provides you with the type of fertilizer for that particular crop. </p>
          ...
          <div class="row align-items-center"> 
            <div class="col-lg-5 col-md-8 mr-auto text-left"> 
              <div class="pr-md-5"> 
                ...
                <h3 class="display-3 text-justify">Yield</h3>
                <p> The yield prediction gives you the amount of bags you will harvest in the next season, of that crop planted</p>
                <!-- <ul class="list-unstyled mt-5"> 
                  ...
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">precise information you.</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2"> 
            ...
            <img class="img-fluid ml-lg-5" src="assets/img/yield.png" width="100%">
            </div>
