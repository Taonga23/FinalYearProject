          ...
          <div class="row row-content">
            <div class="col-md-4 mb-3">
              ...
              <div class="card mb-3">
                ...
                <li class="list-group-item">Admin has access to all the data in the AgroTech system.</li>
				<!-- <li class="list-group-item">Admin can modify and view all the Customer's details when necessory.</li> -->
				<li class="list-group-item">Admin can manage and view all the farmer's details when necessary.</li>
               <li class="list-group-item"> Admin also has access to respond to the queries via each farmer's email.</li>
                <br>
              </ol>
